...
--
-- Host: localhost
-- Generation Time: Aug 15, 2021 at 03:49 PM
...
CREATE TABLE `admin_table` (
  ...
  `hospital_address` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `hospital_contact_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `hospital_logo` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `appointment_table` (
  ...
  `doctor_comment` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `doctor_schedule_table` (
  ...
  `doctor_schedule_day` enum('Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_schedule_start_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_schedule_end_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `average_consulting_time` int(5) NOT NULL,
  `doctor_schedule_status` enum('Active','Inactive') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(22, 2, '2021-08-15', 'Sunday', '20:30', '22:30', 30, 'Active'),
(23, 5, '2021-08-16', 'Monday', '20:30', '23:30', 30, 'Active'),
(24, 1, '2021-08-17', 'Tuesday', '12:30', '23:35', 55, 'Active');
...
CREATE TABLE `doctor_table` (
  `doctor_id` int(11) NOT NULL,
  `doctor_email_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_password` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_profile_image` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_phone_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_address` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_date_of_birth` date NOT NULL,
  `doctor_degree` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_expert_in` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `doctor_status` enum('Active','Inactive') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `patient_table` (
  ...
  `patient_first_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `patient_last_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `patient_date_of_birth` date NOT NULL,
  `patient_gender` enum('Male','Female','Other') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `patient_maritial_status` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `patient_added_on` datetime NOT NULL,
  `patient_verification_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(4, 'oliviabaker@gmail.com', 'password', 'Olivia', 'Bake', '2001-04-05', 'Female', 'Diamond street, 115, NYC', '7539518520', 'Married', '2021-02-19 18:28:23', '8902e16ef62a556a8e271c9930068fea', 'Yes'),
...
--
ALTER TABLE `doctor_schedule_table`
  MODIFY `doctor_schedule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
